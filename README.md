...
این پروژه یک راهنمای جامع و اسکریپت هوشمند برای راه‌اندازی، مدیریت و جفت‌کردن هسته لینوکسی سایفون (`psiphon-core`) با روترهای مبتنی بر **OpenWrt** (به ویژه نسخه 24.10 و پردازنده‌های ۶۴ بیتی با معماری `aarch64_cortex-a53` و `arm_Cortex-A7 (Google Wifi AC-1304)`
...
متغیر GOARCH را باید به جای ۶۴ بیتی (arm64)، روی حالت ۳۲ بیتی (arm) تنظیم کنید تا فایل خروجی روی روتر شما اجرا شود. 
