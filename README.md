...
```bash
# ۱. دریافت سورس کد رسمی هسته سایفون از مخزن لابس
...
* **Proxy Type:** `HTTP`
* **IP Address:** `192.168.18.1` (آی‌پي داخلی روتر شما)
* **Port:** `10809`
EOF

```

حالا با اجرای این کد، فایل دقیق و اصلاح‌شده با نام مخزن درست آماده است. یادآوری به موقع و دقیقت عالی بود!
